...
<div class="container justify-content-center">
    <h4><i>You will hear a sentence. Type the sentence in the box below exactly as you hear it. Write as much of the sentence as you can. You will hear the sentence only once.</i></h4> 
...
var width = 0;
    ...
    function frame() {
      ...
      if (width >= 100) {
        clearInterval(id);
        cont.innerHTML='<button class="btn btn-warning m-2" onclick="listenAgain()">Listen Again</button> <button class="btn btn-success m-2" onclick="saveData()">Submit</button>';
      } else {
        width=width+5; 
