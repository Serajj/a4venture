...
@section('content')
    ...
    <div class="row justify-content-center mt-2"><h4>Look at the text below. In 40 seconds, you must read this text aloud as naturally and clearly as possible. You have <span id="counsec" style="color:red"></span> seconds to read aloud.</h4></div>
    <div class="container" style="min-height: 200px;border:2px solid red">
     <p>For diplomacy, the starting point must be that globalization requires bridges and removes barriers. A policy of containment is a difficult strategy in the age of the fibre-optic cable, the jumbo jet and the satellite dish. There will always be the exception, such as the murderous regime in Iraq where the only safe strategy is to keep it in the isolation ward until it accepts the norms of international behaviour, or the military dictatorship in Burma which has persistently failed to respond to dialogue. It takes two to critically engage.</p>
    </div>

    <div class="row justify-content-center mt-2">
        <button class="btn ctabtn">Next<i class="fas fa-arrow-right" style="color:red;"></i></i></button>
    </div>
	...
	$.ajax({
        ...
        success: function (data) {
           // alert(data);
            ...
            document.getElementById('section').innerHTML='<div class="row justify-content-center mt-30"><h2>Test data is sent for evaluation please goto My Test area to see result..</h2></div>';
        },
        error: function(data){
        alert(data);
    },
