    ...
    <ul class="navbar-nav mr-auto">
       <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href="{{url('progress/speaking/speaking')}}" id="creadaloud">Read Aloud</a>
          <a class="dropdown-item" href="" id="repeatsentence">Repeat Sentence</a>
          <a class="dropdown-item" href="{{url('progress/Describe Image/desimage')}}" id="describeimage">Describe Image</a>
          <a class="dropdown-item" href="#" id="retelllecture">Retell Lecture</a>
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown04">
          <a class="dropdown-item" href="#" id="rsummarize">Summarize Written Text</a>
          <a class="dropdown-item" href="#" id="ressay">Essay</a>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown04">
          <a class="dropdown-item" href="#" id="lsummarize">Summarize Spoken Text</a>
          <a class="dropdown-item" href="#" id="lmultiple">Multiple Choice, Multiple Answer</a>
          <a class="dropdown-item" href="#" id="lfill">Fill in the blanks</a>
          <a class="dropdown-item" href="#" id="lhighlight">Highlight Correct Summary</a>
          ...
          <a class="dropdown-item" href="#" id="lselect">Select Missing Word</a>
         
          <a class="dropdown-item" href="#" id="lhigh">Highlight Incorrect Words</a>
       ...
       <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown04">
          <a class="dropdown-item" href="#">Practise Tests</a>
...
@yield('content')
 ...
 <footer id="footer" class="footersec">
    <div class="container">
      <div class="row">
        <div class="col">
          <h3 class="brdr-hdng white ftrlogo">Site-Logo</h3>
          <p class="parainfo font-italic white mt-4">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Suscipit
            excepturi porro sint ratione obcaecati quae dolore vel nostrum
            nobis culpa?
          </p>
        ...
        <div class="col">
          <ul class="ftr-menu">
            <h6 class="ftrhdng white">Quick Links</h6>
            <li><a id="speakingsec" class="white" href="#">Speaking</a></li>
            <li><a id="writingsec" class="white" href="#">Writing</a></li>
            <li><a id="listeningsec" class="white" href="#">Listening</a></li>
            <li><a id="readingsec" class="white" href="#">Reading</a></li>
            <li><a id="testsec" class="white" href="#">Test</a></li>
            <li><a id="studysec" class="white" href="#">Study</a></li>
          </ul>
        </div>
        <div class="col">
          <ul class="ftr-menu">
        ...
        <div class="col">
          <h6 class="ftrhdng white">Contact</h6>
          <p class="parainfo white mb-0">Contact us to know more about the</p>
          <span class="sitecolor sitename">Company Name</span>
          <p class="parainfo white">Address , Building Number</p>
          <div class="detail-wrapper">
            <div class="phone-wrapper">
              <span class="ico sitecolor"
                ><i class="fa fa-mobile" aria-hidden="true"></i
              ></span>
              <a class="gray" href="tel:+123 123 123">+123 123 123</a>
            </div>
            <div class="email-wrapper">
              <span class="ico sitecolor"
                ><i class="fa fa-envelope-o" aria-hidden="true"></i
              ></span>
              <a class="gray" href="mailto:mail@yourcompany.com"
                >mail@yourcompany.com</a
              >
            </div>
          </div>
  ...
  <div class="cpyrt text-center black-bg py-4">
    <p class="m-0 white">
      &copy;2020 , All Rights Reserved.
      <a href="/" class="highlighted">Company Name</a>
    </p>
  </div>
